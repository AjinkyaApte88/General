...
namespace StorageQueueApp
{
    ...
    class Program
    {
        ...
        {
            string connectionString = "DefaultEndpointsProtocol=https;AccountName=learnqueuestorageaccount;AccountKey=ETeuiF/MHWt1qb09HyPy6BhGPiCaEAKC0FLYhqBAGZhauygZlBliTWSDmh5L9UFPRNZ3N6sHhLZq+AStG/IvmA==;EndpointSuffix=core.windows.net";
        ...
        static async Task ReceiveMessageAsync(QueueClient queueClient)
        {
            ...
            Console.WriteLine("The processing for this message is done, so now it will be deleted");
